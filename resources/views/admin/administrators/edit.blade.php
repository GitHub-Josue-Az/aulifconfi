...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ route('admin.administrators.update', $user->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="string" id="email" name="email" value="{{old('email', $user->email)}}" class="form-control @error('email') is-invalid @enderror" maxlength="100" required="">
                        @error('email')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                        @endif
                    </div>
